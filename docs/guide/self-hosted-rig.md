...
- **Never pool a seat.** A subscription seat is one human's entitlement. One seat, one runner, one operator. If you want a second runner, use a second seat — or switch that runner to the metered API-key path. Sharing a seat across runners or people is neither sanctioned nor safe.
