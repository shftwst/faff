...
2. **The recorded reconciliation baseline** — real `claude -p` reps over the three committed `reconciliation-*.json` cases, captured as:
   ...
   - an **optional committable ADR addendum** to `docs/adr/0004-judgement-evals-spike.md` recording the headline reconciliation numbers (the FAFF-131 / FAFF-156 pattern — the one durable, version-controlled record).
...
| `docs/adr/0004-*.md` | optional addendum | optional addendum |
...
4. **Optional committable ADR addendum** to `docs/adr/0004-*.md` with the headline numbers (human decides whether to commit it).
