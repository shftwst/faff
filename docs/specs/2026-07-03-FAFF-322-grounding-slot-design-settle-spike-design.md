...
| Shipped forward-interface | `prdr-yagni` fixtures (`bin/faff` ~:6138–6147), gateway `SKILL.md` ~:963, `docs/specs/2026-06-27-FAFF-256-prdr-yagni-guard-design.md` | "Advisory when present, never required" — committed consumer behaviour |
...
- **ADR + refutation log** → committed on this ticket's branch, shipped by PR (the FAFF-278 precedent: `docs/adr/00NN-….md` + the log alongside).
