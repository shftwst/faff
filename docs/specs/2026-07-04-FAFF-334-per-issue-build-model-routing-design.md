...
| FAFF-315 spec | `docs/specs/2026-07-03-FAFF-315-per-lane-model-selection-design.md:112` | Names this ticket by design: "per-issue routing is a future rung on the same key (`models.build` grows a matcher), not a redesign" |
