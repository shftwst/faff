...
| `docs/adr/` | 41 ADRs | The decision log axis 4 reads against |
...
**Chosen:** findings doc lands at `docs/audits/2026-07-04-faff-323-whole-system-coherence.md` (the `docs/audits/` directory already exists and holds the FAFF-114 audit precedent).
...
Then docs/audits/2026-07-04-faff-323-whole-system-coherence.md exists on the
...
- **Why `docs/audits/`?** Audit precedent exists there (FAFF-114 doc); `docs/` outside `docs/guide/` is allow-by-default for FAFF-NN/ADR refs (`faff lint-refs` slice-1 scope is `docs/guide/**` only), and it is neither guide prose nor a spec. **Chosen:** `docs/audits/`.
...
- [ ] Doc committed at `docs/audits/2026-07-04-faff-323-whole-system-coherence.md` on branch `faff-323-frontier-whole-system-coherence-audit`, shipping in the PR with the spec.
