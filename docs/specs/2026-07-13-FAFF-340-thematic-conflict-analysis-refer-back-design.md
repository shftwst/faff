...
Audit `docs/audits/2026-07-04-faff-323-whole-system-coherence.md` → **R2 / T6**. The project's skill-authoring standard is explicit: shared prose has one home — reference it, never copy. A recap that exists is a recap that can rot; this one did.
