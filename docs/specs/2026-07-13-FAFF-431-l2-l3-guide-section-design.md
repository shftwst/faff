...
- **Skimmable house style.** Per `docs/skill-authoring.md` and the repo's guide voice: tables and bullets over prose walls; second person; no invented labelling schemes.
