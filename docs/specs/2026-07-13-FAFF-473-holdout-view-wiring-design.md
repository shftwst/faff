...
Then the committed docs/specs/*-design.md contains the visible scenario and the withheld-count note, and does NOT contain the holdout scenario text
```
