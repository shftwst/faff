...
- **Skill-authoring standard applies** (`docs/skill-authoring.md`): lean, skimmable, no changelog-in-prose. State the rule forward. `faff validate-adapters` gates the lintable subset (line caps, stray markers) in CI.
...
- **Other FAFF-323 audit findings beyond D5 + R4/T4.** — Why excluded: each audit finding is its own ticket. — Extension point: `docs/audits/2026-07-04-faff-323-whole-system-coherence.md`.
