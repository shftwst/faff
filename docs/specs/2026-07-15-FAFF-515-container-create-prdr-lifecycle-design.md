...
| ADR-0071 | `docs/adr/0071-l4-topology-write-authority-…md` | Status Proposed. Its Consequences invite this reopening as "a larger, separate decision". Carries the two-floor-proof methodology every `admit` row must satisfy. |
