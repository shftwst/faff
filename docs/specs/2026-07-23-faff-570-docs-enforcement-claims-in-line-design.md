...
| `docs/audits/2026-07-20-l4-capabilities-audit.md` (§2, correction round) | Markdown | Source-of-truth for the attested-vs-enforced boundary; its own correction round is the evidence bullet 5 (account-tier) is a non-issue. |
