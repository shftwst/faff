...
| `docs/adr/0054-…transport-selection.md`, `docs/adr/0076-…substrate.md` | prose | The decisions this extends |
| `docs/architecture/harness-coupling.md` (subagent-dispatch row) | prose | Names FAFF-593 as the follow-on; currently describes engine call as "a CLI spawn" — this ticket makes that partially true |
...
- [ ] `docs/architecture/harness-coupling.md` subagent-dispatch row updated; ADR recording the spawn-family branch (extending ADR-0054) authored at graft
