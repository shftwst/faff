...
`docs/spikes/2026-07-26-FAFF-654/RESULTS.md`'s `## Structural guarantee` names **five** byte-emitting exceptions and asserts `exceptions_are_complete: nothing else in the probe writes bytes obtained from a measured file`. That count is false against the instrument.
