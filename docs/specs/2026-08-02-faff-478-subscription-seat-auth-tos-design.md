...
The deliverable is a single **ADR** under `docs/adr/` (the repo's Nygard Context/Decision/Consequences convention), **related to ADR-0076 (amends the ambient-session-only deferral) and ADR-0090 (Codex reference)**, recording per provider (Codex/ChatGPT, Claude Max):
...
- [ ] An ADR is committed under `docs/adr/` (Nygard format), **related to ADR-0076 (amends) and ADR-0090 (references)**.
