...
| `docs/adr/0003-live-driver-spike.md` | — | Records the original race and commits to per-run config isolation as a must-have |
| `docs/adr/0054-…transport-selection.md` | — | Line 17 reserves the tool-needing `claude -p` branch, "not built here" |
