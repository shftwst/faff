...
| `docs/audits/tools/faff-435/validate-report.mjs` | JS (ESM) | `computeAggregate` (~13) checks `reader_contexts` shape only; tighten to the FAFF-435 §4 per-context fields |
