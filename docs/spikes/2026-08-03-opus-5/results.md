...
The same rig can run a peer-frontier control (e.g. GPT-5.6-sol) on the identical corpus once the harness supports a non-Anthropic engine for the eval lane — see `docs/external-verification/faff-labs/experiments/l4-experiment-design.md`.
