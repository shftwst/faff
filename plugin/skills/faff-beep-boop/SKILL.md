...
4. **Invoke the `prd_validator` slot** via the Skill tool (resolve per gateway → **Sibling-skill invocation**), passing the PRD file content. It emits one `faff-contract:prd-readiness` block.
