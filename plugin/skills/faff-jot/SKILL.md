...
- Create containers first (initiative/project), then tickets, then the blocker/blocked-by links the methodology proposed. (Each ticket's open questions land in its template's `Open questions` field.)
