...
4. **The re-sliced epics land in Backlog** (`faff-jot-intake`, plot's normal create path) and **re-enter this run's wave loop** — the run converges rather than stopping (FAFF-499 owns the convergence-drain mechanics; this step only hands off into it).
