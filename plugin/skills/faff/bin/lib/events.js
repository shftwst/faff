...
function cmdEvents(args) {
  ...
  if (gate.errors.length) return usageError(gate.errors, "usage: faff events <append|validate|read> [--run ID] [--file F] [--ts T] [--tokens] [--session-id ID] [--type T] [--issue ID] [--json] [--root DIR]");
