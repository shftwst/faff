...
const CONTROL_LABELS = [
  ...
  { name: "faff-awaiting-spec-review", color: "#f2c94c",
    description: "A spec holding for spec-review-provider recovery; the next prep drain re-enters at the review gate (spec re-production skipped). Applied by faff-prep on a swing-capable spec-review outage past the in-turn retry ceiling; cleared by faff-prep (on terminal disposition) or faff-tidy (stale-label auto-clear on state moves). NOT a park (faff-parked, above) and NOT the build-side faff-awaiting-review — a distinct prep-altitude hold so the two stay separable in `faff disposition` / `/faff-wtf` (FAFF-900)." },
