...
const SKILL_LINE_CAP_OVERRIDE = { faff: 1136, "faff-beep-boop": 705, "faff-graft": 622 };   // the gateway is the shared-prose hub (single-source home, FAFF-115); it grows (FAFF-749: +2 for concurrency obligation 6; FAFF-758: +2 for the second monotonicity carve-out + the split labels-manifest paragraph; FAFF-750: +2 for concurrency obligation 7 — the merge locus moves above the dispatch cut; faff-graft +2 for Step 10's dispatch-cut split + the pr-ready return)
