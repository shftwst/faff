...
const SKILL_LINE_CAP_OVERRIDE = { faff: 1135, "faff-beep-boop": 719, "faff-graft": 620 };   // the gateway is the shared-prose hub (single-source home, FAFF-115); it grows (FAFF-749: +2 for concurrency obligation 6; FAFF-758: +2 for the second monotonicity carve-out + the split labels-manifest paragraph)   // FAFF-728: +1 gateway (GitHub-auth preflight bullet) + 14 beep-boop (GitHub-auth preflight surfacing section)
