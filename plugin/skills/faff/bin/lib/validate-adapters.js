...
const SKILL_LINE_CAP_OVERRIDE = { faff: 1110, "faff-beep-boop": 690 };   // the gateway is the shared-prose hub (single-source home, FAFF-115); it grows
                                                  ...
                                                  // it past 660) — both caps are calibrated to the hub's real size while still forcing leanness per addition.
