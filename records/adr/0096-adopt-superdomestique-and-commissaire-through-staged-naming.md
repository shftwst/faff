...
Public prose introduces the relationship as "SuperDomestique, currently shipped as `faff`". It uses SuperDomestique for the target product story, Commissaire for the target governance responsibility, and `faff` for literal current interfaces. The canonical definitions and writing rules live in [Positioning and language](../../docs/concept/positioning-and-language.md).
...
- The earlier brief remains an unshipped historical input; this ADR and the canonical language guide carry forward the retained decisions.
