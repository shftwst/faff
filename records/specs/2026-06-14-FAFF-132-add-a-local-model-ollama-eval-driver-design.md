...
- **Cross-driver measurement (the actual numbers).** — Excluded: running ~240 reps against frontier + a local model and tabulating the real accuracy/flakiness delta is a budgeted, supervised run. — Extension point: **FAFF-131** consumes this preset; it fills `records/adr/0004-*.md`.
