...
| `records/adr/0004-judgement-evals-spike.md` | Markdown | The committable record; this ticket appends a dated addendum |
...
PROCEDURE record_carved_baselines():
  ...
  4. RECORD — append ONE dated addendum to records/adr/0004-judgement-evals-spike.md:
...
Then records/adr/0004-judgement-evals-spike.md gains exactly one dated addendum containing the verdict-build,
...
### From HOW (recording)
- [ ] Exactly one dated addendum appended to `records/adr/0004-judgement-evals-spike.md`.
