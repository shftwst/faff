...
```
# OLD records/adr/MMMM-*.md:  - **Status:** Superseded by ADR-NNNN
# NEW records/adr/NNNN-*.md:  - **Supersedes:** ADR-MMMM
```
...
**Smoke test:**
```
1. temp records/adr 0001..0003 → faff adr supersede 0001 --by 0003
