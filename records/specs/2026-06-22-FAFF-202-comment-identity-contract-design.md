...
- [ ] The added prose is lean/deduplicated/skimmable per the skill-authoring charter (`docs/reference/skill-authoring.md`): bullets/tables over prose walls, the procedure stated once in the gateway.
