...
| `records/specs/2026-06-22-FAFF-202-comment-identity-contract-design.md` | Committed spec | The contract this extends; its §3 match predicate and §2 OUT-OF-SCOPE note. |
...
- [ ] The added prose is lean/deduplicated/skimmable per `docs/reference/skill-authoring.md` — the predicate is stated once, in the gateway.
