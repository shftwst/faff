...
| `records/specs/2026-06-23-FAFF-201-…-design.md` | FAFF-201's design spec; its OUT-OF-SCOPE names "Prep-queue subagent dispatch" as the deferred sibling. Confirms intent; not edited. |
