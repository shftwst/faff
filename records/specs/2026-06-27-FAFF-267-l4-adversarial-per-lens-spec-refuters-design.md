...
| `records/adr/0025-distinct-spec-review-slot-fixed-spec-review-verdict-contract.md` | Markdown/ADR | Establishes the slot + contract; states severity→verdict mapping is FAFF-266/267's judgement. |
