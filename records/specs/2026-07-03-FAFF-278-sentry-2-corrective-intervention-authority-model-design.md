...
|---|---|---|
| The un-subvertability argument | `records/adr/0034-…md` (Proposed) | The claim a redirect must not break; names the correct/redirect deferral + the isolation co-binding revisit trigger |
...
| Spike precedent | FAFF-263 → `records/adr/0029-…md` | The deliverable shape: measured decisive risk, narrow boundary, caveats, costed follow-ups, human sign-off |
| Effects ledger | `records/specs/2026-06-30-faff-106-…md`, `faff effects` | The actual forbidden-side-effect signal producer (the Sentry-1 text mis-attributes this to FAFF-42 — corrected by this spike's ADR) |
