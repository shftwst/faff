...
| `records/adr/0030-…proposer-critic-boundary.md` | The settled boundary this wiring implements — authority, not modified |
...
**Assumptions:**
- **Assumes:** ADR-0030 (Accepted) stands as the boundary authority — proposal lands in the spec, critic reads it there. Validation: `records/adr/0030-…md` status line before build.
