...
- **A new ADR** — ADR-0037 (`records/adr/0037-appetite-is-level-scoped-l4-forces-full.md`) already says "an **active**-L4 run ledger"; this fix implements the liveness half of the recorded intent. No decision changes.
