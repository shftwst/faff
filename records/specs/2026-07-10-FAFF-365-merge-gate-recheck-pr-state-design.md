...
---
*Prepped autonomously (beep-boop run 2026-07-05-beep-boop-list-030000). Spec-review: approve (architectural/infosec/QA, single-pass). Full spec on the tracker; ships to `records/specs/` with the build PR.*
