...
| Authority model | `records/adr/0039-…` + `records/spikes/2026-07-03-FAFF-278-corrective-authority-refutation-log.md` (Decision 2, costed follow-up 3) | The admissibility criterion and the subtractive-authority ethos this design instantiates |
