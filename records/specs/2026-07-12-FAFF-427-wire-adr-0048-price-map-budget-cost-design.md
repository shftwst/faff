...
| `records/adr/0048-per-model-x-per-class-token-pricing-model.md` | Names the map + precedence; explicitly defers the "two cost figures coexist" reconciliation to this work |
