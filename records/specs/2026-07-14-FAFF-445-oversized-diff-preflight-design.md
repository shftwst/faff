...
| `records/specs/2026-07-12-FAFF-414-review-callmjs-advance-the-fallback-chain-on-a-non-transient-design.md` | markdown | FAFF-414's spec — §2 OUT OF SCOPE names this exact preflight as deferred; §6 established the "reuse an existing needs-human exit class over minting a new one" precedent this spec follows. |
