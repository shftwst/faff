...
One-pass status curation of `records/adr/`: the mechanical `Proposed → Accepted` flips of the audit's R5/D-class set, resolution of the 0034/0039 acceptance inversion, and an optional non-failing `adr validate` advisory surfacing future Accepted-cites-Proposed incoherence.
