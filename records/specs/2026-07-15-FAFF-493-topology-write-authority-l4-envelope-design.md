...
| ADR-0035 | `records/adr/0035-…:16,31,40,42` | Decides the dial; reversibility floor (`:31`), one-definitional-home (`:40`), "`full` is the meaningful new capability *and* risk" (`:42`). |
| ADR-0037 | `records/adr/0037-…:17` | "At L4 appetite resolves to `full` unconditionally" — the only path L4 reaches the dial. |
