...
| `records/adr/0034-*.md` | The FAFF-324 amendment; its "Follow-up guard" section is this ticket's direct source. Its "reconcile inline at check time" instruction is the open call now owned by FAFF-511. |
