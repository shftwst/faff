...
- **The disposition-table doc** (`docs/reference/architecture/harness-coupling.md`, FAFF-592) — why excluded: its WorktreeCreate row already records this outcome with FAFF-595 as the follow-on; no edit needed whether it lands before or after this change. Extension point: that doc's own "how to extend" note.
