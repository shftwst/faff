...
- **Ground every correction in shipped behaviour.** The `verification/audits/2026-07-20-l4-capabilities-audit.md` boundary and the named modules (`sentry.js`, `lights-out.js`, `corrective-integrity.js`) are the source of truth — not the doc's own prior wording.
