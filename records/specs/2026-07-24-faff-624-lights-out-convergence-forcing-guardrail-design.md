...
| `records/specs/2026-07-23-faff-534-within-run-convergence-default-posture-design.md` | Committed spec | The substrate decision: posture shipped as prose/config; the code guarantee explicitly deferred here; the "never consult" anti-pattern. |
