...
- **Historical documents naming the old path** — the FAFF-518 spec (`records/specs/2026-07-16-…`), ADR-0073's illustrative mention, `verification/audits/2026-07-20-l4-capabilities-audit.md`. Excluded: they are records of decisions and findings at a point in time, not living docs. The living doc is `docs/guide/cli.md`, which is updated here.
