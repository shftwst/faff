...
Add a zero-dependency harness under `verification/audits/tools/faff-435/`:
...
The committed human report is `verification/audits/<date>-FAFF-435-l4-gate-subversion.md`; machine artifacts live in its named companion directory.
