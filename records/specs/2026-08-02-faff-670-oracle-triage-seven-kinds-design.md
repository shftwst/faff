...
**Chosen:** Yes — edit exactly two lines in `records/specs/2026-07-24-faff-625-holdout-error-rate-production-run-offline-proxy-lower-bound-design.md`: the inputs-table path at line 27 and the smoke command inside the `**Assumes:**` clause at line 183. Nothing else in that document is touched.
