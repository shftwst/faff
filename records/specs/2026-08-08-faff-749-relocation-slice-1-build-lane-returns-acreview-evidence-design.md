...
| `records/adr/0077-...evidence-writes-cross-to-the-trusted.md` (Decision, item 1) | ADR | Governing decision; the honest-scope carve-out |
| `records/adr/0078-digest-custody-bracket-as-concurrency-contract-obligation-5.md` + FAFF-520 spec | ADR/spec | The exit-1 park path this slice reuses |
