...
**Reproduce:** `node records/spikes/2026-07-10-faff-411/analyze.mjs --out analyze-output.json` (read-only over the main checkout's `.faff/runs/`, `records/specs/`, and `faff economics`). Machine output committed alongside as `analyze-output.json`.
