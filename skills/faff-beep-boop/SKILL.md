...
```
python3 ~/.claude/skills/faff/faff runcheck   # audits the latest .faff/runs/* ledger
```
...
```json
{
  "hooks": {
    "Stop": [
      { "type": "command", "command": "python3 \"${CLAUDE_PLUGIN_ROOT}/skills/faff/faff\" runcheck --hook" }
    ]
  }
}
```
