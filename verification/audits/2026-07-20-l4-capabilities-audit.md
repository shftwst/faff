...
- **Docs/decisions:** ADRs 0034–0080; an unshipped tamper-evidence design input; `docs/guide/{unattended,architecture,governance-check,adopting-by-change-class}.md`. The landscape report used during this point-in-time audit was also an unshipped research input whose claims required re-verification; their disposition is recorded in [`2026-08-09-unshipped-record-reference-register.md`](2026-08-09-unshipped-record-reference-register.md).
...
- **Prior audits:** `verification/audits/2026-07-04-faff-323-whole-system-coherence.md`; `verification/audits/FAFF-114-skill-prompt-audit.md`.
