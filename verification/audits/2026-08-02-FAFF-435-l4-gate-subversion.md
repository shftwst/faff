...
```sh
node verification/audits/tools/faff-435/validate-report.mjs verification/audits/2026-08-02-FAFF-435-l4-gate-subversion/audit-report.json
node verification/audits/tools/faff-435/validate-report.mjs --selftest
```
