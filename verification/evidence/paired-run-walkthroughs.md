...
[Why one run continued and another stopped](../../docs/guide/run-outcomes.md). It keeps
...
1. **Input.** The ticket had an automation-eligible tracker record and a
   [high-confidence specification](https://github.com/shftwst/faff/blob/82c5898/records/specs/2026-08-04-faff-620-sentrycheck-hook-defensive-catch-design.md).
